	...
	namespace cpu
	{
		namespace z80
		{
			namespace timing
			{
				...
				static const int LD_dIY_n8 = 19;
				static const int LD_dIX_r8 = 19;
				static const int LD_dIY_r8 = 19;
				...
				static const int LD_n16_IY = 20;
				static const int LD_r16_r8 = 7;
				static const int LD_IXHL_n8 = 7;
				static const int LD_IYHL_n8 = 7;
