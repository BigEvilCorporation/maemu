	...
	namespace cpu
	{
		namespace z80
		{
			const Opcode OpcodeTableFDCB[Z80_MAX_OPCODE_TABLE_SIZE] =
			{
				...
				{ 0x46, 1, &opcodes::BIT_b_dIY,		"BIT", "0, (IY+#)" },
				...
				{ 0x4E, 1, &opcodes::BIT_b_dIY,		"BIT", "1, (IY+#)" },
				...
				{ 0x56, 1, &opcodes::BIT_b_dIY,		"BIT", "2, (IY+#)" },
				...
				{ 0x5E, 1, &opcodes::BIT_b_dIY,		"BIT", "3, (IY+#)" },
				...
				{ 0x66, 1, &opcodes::BIT_b_dIY,		"BIT", "4, (IY+#)" },
				...
				{ 0x6E, 1, &opcodes::BIT_b_dIY,		"BIT", "5, (IY+#)" },
				...
				{ 0x76, 1, &opcodes::BIT_b_dIY,		"BIT", "6, (IY+#)" },
				...
				{ 0x7E, 1, &opcodes::BIT_b_dIY,		"BIT", "7, (IY+#)" },
				...
				{ 0x86, 1, &opcodes::RES_b_dIY,			"RES", "0, (IY+#)" },
				...
				{ 0x8E, 1, &opcodes::RES_b_dIY,			"RES", "1, (IY+#)" },
				...
				{ 0x96, 1, &opcodes::RES_b_dIY,			"RES", "2, (IY+#)" },
				...
				{ 0x9E, 1, &opcodes::RES_b_dIY,			"RES", "3, (IY+#)" },
				...
				{ 0xA6, 1, &opcodes::RES_b_dIY,			"RES", "4, (IY+#)" },
				...
				{ 0xAE, 1, &opcodes::RES_b_dIY,			"RES", "5, (IY+#)" },
				...
				{ 0xB6, 1, &opcodes::RES_b_dIY,			"RES", "6, (IY+#)" },
				...
				{ 0xBE, 1, &opcodes::RES_b_dIY,			"RES", "7, (IY+#)" },
				...
				{ 0xC6, 1, &opcodes::SET_b_dIY,			"SET", "0, (IY+#)" },
				...
				{ 0xCE, 1, &opcodes::SET_b_dIY,			"SET", "1, (IY+#)" },
				...
				{ 0xD6, 1, &opcodes::SET_b_dIY,			"SET", "2, (IY+#)" },
				...
				{ 0xDE, 1, &opcodes::SET_b_dIY,			"SET", "3, (IY+#)" },
				...
				{ 0xE6, 1, &opcodes::SET_b_dIY,			"SET", "4, (IY+#)" },
				...
				{ 0xEE, 1, &opcodes::SET_b_dIY,			"SET", "5, (IY+#)" },
				...
				{ 0xF6, 1, &opcodes::SET_b_dIY,			"SET", "6, (IY+#)" },
				...
				{ 0xFE, 1, &opcodes::SET_b_dIY,			"SET", "7, (IY+#)" },
