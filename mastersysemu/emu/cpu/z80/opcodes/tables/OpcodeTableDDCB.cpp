...
namespace emu
{
	namespace cpu
	{
		namespace z80
		{
			...
			{
				{ 0x00, 1, &opcodes::RLC_dIX_r8,	"RLC", "(IX+#)->B" },
				{ 0x01, 1, &opcodes::RLC_dIX_r8,	"RLC", "(IX+#)->C" },
				{ 0x02, 1, &opcodes::RLC_dIX_r8,	"RLC", "(IX+#)->D" },
				{ 0x03, 1, &opcodes::RLC_dIX_r8,	"RLC", "(IX+#)->E" },
				{ 0x04, 1, &opcodes::RLC_dIX_r8,	"RLC", "(IX+#)->H" },
				{ 0x05, 1, &opcodes::RLC_dIX_r8,	"RLC", "(IX+#)->L" },
				{ 0x06, 1, &opcodes::RLC_dIX,		"RLC", "(IX+#)" },
				{ 0x07, 1, &opcodes::RLC_dIX_r8,	"RLC", "(IX+#)->A" },
				...
				{ 0x46, 1, &opcodes::BIT_b_dIX,		"BIT", "0, (IX+#)" },
				...
				{ 0x4E, 1, &opcodes::BIT_b_dIX,		"BIT", "1, (IX+#)" },
				...
				{ 0x56, 1, &opcodes::BIT_b_dIX,		"BIT", "2, (IX+#)" },
				...
				{ 0x5E, 1, &opcodes::BIT_b_dIX,		"BIT", "3, (IX+#)" },
				...
				{ 0x66, 1, &opcodes::BIT_b_dIX,		"BIT", "4, (IX+#)" },
				...
				{ 0x6E, 1, &opcodes::BIT_b_dIX,		"BIT", "5, (IX+#)" },
				...
				{ 0x76, 1, &opcodes::BIT_b_dIX,		"BIT", "6, (IX+#)" },
				...
				{ 0x7E, 1, &opcodes::BIT_b_dIX,		"BIT", "7, (IX+#)" },
				...
				{ 0x86, 1, &opcodes::RES_b_dIX,			"RES", "0, (IX+#)" },
				...
				{ 0x8E, 1, &opcodes::RES_b_dIX,			"RES", "1, (IX+#)" },
				...
				{ 0x96, 1, &opcodes::RES_b_dIX,			"RES", "2, (IX+#)" },
				...
				{ 0x9E, 1, &opcodes::RES_b_dIX,			"RES", "3, (IX+#)" },
				...
				{ 0xA6, 1, &opcodes::RES_b_dIX,			"RES", "4, (IX+#)" },
				...
				{ 0xAE, 1, &opcodes::RES_b_dIX,			"RES", "5, (IX+#)" },
				...
				{ 0xB6, 1, &opcodes::RES_b_dIX,			"RES", "6, (IX+#)" },
				...
				{ 0xBE, 1, &opcodes::RES_b_dIX,			"RES", "7, (IX+#)" },
				...
				{ 0xC6, 1, &opcodes::SET_b_dIX,			"SET", "0, (IX+#)" },
				...
				{ 0xCE, 1, &opcodes::SET_b_dIX,			"SET", "1, (IX+#)" },
				...
				{ 0xD6, 1, &opcodes::SET_b_dIX,			"SET", "2, (IX+#)" },
				...
				{ 0xDE, 1, &opcodes::SET_b_dIX,			"SET", "3, (IX+#)" },
				...
				{ 0xE6, 1, &opcodes::SET_b_dIX,			"SET", "4, (IX+#)" },
				...
				{ 0xEE, 1, &opcodes::SET_b_dIX,			"SET", "5, (IX+#)" },
				...
				{ 0xF6, 1, &opcodes::SET_b_dIX,			"SET", "6, (IX+#)" },
				...
				{ 0xFE, 1, &opcodes::SET_b_dIX,			"SET", "7, (IX+#)" },
