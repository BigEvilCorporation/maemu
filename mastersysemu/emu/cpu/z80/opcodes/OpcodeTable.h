	...
	namespace cpu
	{
		namespace z80
		{
			static const Opcode OpcodeTable[] =
			{
				...
				{ 0xB8, 0, &opcodes::CP_B,    "CP", "B" },
				{ 0xB9, 0, &opcodes::CP_C,    "CP", "C" },
				{ 0xBA, 0, &opcodes::CP_D,    "CP", "D" },
				{ 0xBB, 0, &opcodes::CP_E,    "CP", "E" },
				{ 0xBC, 0, &opcodes::CP_H,    "CP", "H" },
				{ 0xBD, 0, &opcodes::CP_L,    "CP", "L" },
				{ 0xBE, 0, &opcodes::CP_HL,   "CP", "HL" },
				{ 0xBF, 0, &opcodes::CP_A,    "CP", "A" },
